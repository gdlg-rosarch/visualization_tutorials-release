...
pkgname='ros-lunar-visualization-tutorials'
pkgver='0.10.2_1'
pkgrel=1
arch=('any')
license=('BSD'
...
depends=('ros-lunar-interactive-marker-tutorials'
'ros-lunar-librviz-tutorial'
'ros-lunar-rviz-plugin-tutorials'
'ros-lunar-rviz-python-tutorial'
